...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('dasite_core_path', null,
                    $modx->getOption('core_path') . 'components/dasite/') . 'model/';
            $modx->addPackage('dasite', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/dasite/model/schema/dasite.mysql.schema.xml';
